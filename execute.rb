require './dragon/frame_dragon.rb'
require './dragon/ice_dragon.rb'

enemy_dragon = FrameDragon.new(name: "バーニル", player_flag: false)
player_dragon = IceDragon.new(name: "アイピス", player_flag: true)
